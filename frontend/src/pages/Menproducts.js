...
function Menproducts() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
          ...
          try {
            ...
            if (searchQuery) {
              ...
              setMenproducts(response.data.Menproducts);
            }
        ...
        const handleCardClick = (product) => {
            navigate(`/allproducts/Men/${product._id}`);
          };
  return (
    <div>
      <div>
                ...
                <div style={{ maxWidth: "1200px", margin: "0 auto", width: "100%" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2rem", flexWrap: "wrap", gap: "1rem" }}>
                        <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
                            ...
                            <button style={{ padding: "0.5rem 1.25rem", backgroundColor: "#D4AF37", color: "white", border: "1px solid #e5e7eb", borderRadius: "0.375rem", fontWeight: "500", cursor: "pointer" }} onClick={GotoMenproducts}>Men</button>
