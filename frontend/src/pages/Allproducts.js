...
function Allproducts() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        if (searchQuery) {
          ...
          setAllTheProducts(response.data.AllProducts);
        }
    ...
    const sortedProducts = () => {
        let sortedArray = [...AllTheProducts];
                ...
                <div style={{ maxWidth: "1200px", margin: "0 auto", width: "100%" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2rem", flexWrap: "wrap", gap: "1rem" }}>
                        <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
                            <button style={{ padding: "0.5rem 1.25rem", backgroundColor: "#D4AF37", color: "white", border: "none", borderRadius: "0.375rem", fontWeight: "500", cursor: "pointer" }} onClick={GotoAllproducts}>All</button>
                            ...
                            <button style={{ padding: "0.5rem 1.25rem", backgroundColor: "white", color: "#374151", border: "1px solid #e5e7eb", borderRadius: "0.375rem", fontWeight: "500", cursor: "pointer" }} onClick={GotoWomenproducts}>Women</button>
                        </div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(250px, 1fr))", gap: "2rem" }}>
                        {sortedProducts().map((product) => (
                            <div
                                ...
                                key={product._id}  onClick={()=>{handleCardClick(product._id)}}
                            >
                                ...
                                <div style={{ padding: "1.25rem" }}>
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", marginBottom: "1rem" }}>
                                        ...
                                        <span style={{ fontSize: "0.85rem", color: "#6b7280" }}>{product.description}</span>
                                    </div>
